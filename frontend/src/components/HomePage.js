...
const HomePage = () => {
  ...
  const translations = {
    ...
    it: {
      ...
      // Hero Section
      heroTitle: "Icar Assistance",
      heroSubtitle: "Per un'assistenza stradale in piena fiducia, chiama Icar Assistance!",
    ...
    de: {
      ...
      // Hero Section
      heroTitle: "Icar Assistance",
      heroSubtitle: "Für vertrauensvolle Pannenhilfe rufen Sie Icar Assistance an!",
  ...
  return (
    <div className="min-h-screen bg-[#C1BFB1]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {services.map((service, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-white to-[#E8E8E8]/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-[#E8E8E8]/20 hover:border-[#2A5CAA]/40 hover:shadow-lg transition-all duration-300"
              >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <motion.button
                onClick={getLocation}
                className="inline-flex items-center space-x-3 bg-[#625B48] hover:bg-[#4A453A] text-white px-8 py-4 rounded-full text-lg font-bold transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <MessageCircle className="w-6 h-6" />
            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#625B48] rounded-full flex items-center justify-center flex-shrink-0">
      ...
      <section id="testimonials" className="py-20 bg-[#606060]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* FAQ Section */}
      <section className="py-20 bg-[#C1BFB1]">
      ...
      {/* Devis Section */}
      <section id="quote" className="py-20 bg-[#606060]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-gradient-to-r from-[#625B48] to-[#625B48]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="mt-8 flex items-center justify-center space-x-2 text-[#C1BFB1]">
