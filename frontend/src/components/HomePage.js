...
const HomePage = () => {
  ...
  const translations = {
    ...
    en: {
      ...
      heroDescription: "For <strong>more than 15 years</strong>, <strong>Auto Express</strong> has been the specialist in automotive breakdown and towing services in <strong>Montpellier and its metropolitan area</strong>. Available 7 days a week, 24 hours a day, and equipped with a fleet of high-performance vehicles and equipment, our team intervenes <strong>quickly, efficiently and safely</strong>, whatever the situation. We offer <strong>a complete service</strong>, ranging from assistance in case of breakdown to recovery, including long-distance towing in France or abroad (Spain, Italy, Germany...). Our expertise, responsiveness and sense of service make <strong>Auto Express a trusted ally</strong> for individuals and professionals alike. With us, no unpleasant surprises: you are <strong>in good hands</strong>, from the first call to getting your vehicle back on the road.",
    ...
    es: {
      ...
      // Hero Section
      heroTitle: "Icar Assistance",
      heroSubtitle: "¡Para una asistencia en carretera sin estrés, llame a Icar Assistance!",
    ...
    it: {
      ...
      heroDescription: "Da <strong>più di 15 anni</strong>, <strong>Auto Express</strong> è lo specialista del soccorso stradale e del traino automobilistico a <strong>Montpellier e nella sua area metropolitana</strong>. Disponibile 7 giorni su 7, 24 ore su 24, e dotato di una flotta di veicoli e attrezzature ad alte prestazioni, il nostro team interviene <strong>rapidamente, efficacemente e in totale sicurezza</strong>, qualunque sia la situazione. Offriamo <strong>un servizio completo</strong>, dall'assistenza in caso di guasto al soccorso, passando per il traino a lunga distanza in Francia o all'estero (Spagna, Italia, Germania...). La nostra competenza, reattività e senso del servizio rendono <strong>Auto Express un alleato di fiducia</strong> sia per i privati che per i professionisti. Con noi, nessuna brutta sorpresa: siete <strong>in buone mani</strong>, dalla prima chiamata fino alla rimessa in strada del vostro veicolo.",
    ...
    ar: {
      ...
      heroDescription: "منذ <strong>أكثر من 15 عاماً</strong>، تُعتبر <strong>أوتو إكسبريس</strong> الخبيرة المختصة في إصلاح الأعطال وسحب السيارات في <strong>مونبلييه ومنطقتها الحضرية</strong>. متاحة 7 أيام في الأسبوع، 24 ساعة في اليوم، ومجهزة بأسطول من المركبات والمعدات عالية الأداء، يتدخل فريقنا <strong>بسرعة وفعالية وبأمان تام</strong>، مهما كانت الحالة. نحن نقدم <strong>خدمة شاملة</strong>، تتراوح من المساعدة في حالة العطل إلى الإنقاذ، مروراً بالسحب لمسافات طويلة في فرنسا أو في الخارج (إسبانيا، إيطاليا، ألمانيا...). خبرتنا وسرعة استجابتنا وحس الخدمة لدينا يجعل من <strong>أوتو إكسبريس حليفاً موثوقاً</strong> للأفراد والمهنيين على حد سواء. معنا، لا توجد مفاجآت سيئة: أنتم <strong>في أيد أمينة</strong>، من أول مكالمة حتى إعادة تشغيل مركبتكم.",
