                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 448 512">
                      <path d="M224 0c-35.26 0-64 28.74-64 64 0 35.26 28.74 64 64 64s64-28.74 64-64c0-35.26-28.74-64-64-64zm186.64 384.67c-19.59 0-35.85-15.64-36.46-35.15-.01-.15-.01-.31-.01-.46 0-19.88 16.12-36 36-36s36 16.12 36 36c0 19.88-16.12 36-36 36zm-335.28 0c-19.88 0-36-16.12-36-36s16.12-36 36-36 36 16.12 36 36-16.12 36-36 36z"/>
                    </svg>
                  </motion.a>
                </div>
              </div>
